<aside class="w-20 bg-white dark:bg-gray-800 flex flex-col items-center py-6 space-y-6 shadow">
    <a href="{{ route('admin.dashboard') }}" wire:navigate class="text-gray-700 dark:text-gray-300 hover:text-blue-600">
        <!-- Home Icon -->
    ...
    <a href="{{ route('admin.properties') }}" wire:navigate class="text-gray-700 dark:text-gray-300 hover:text-blue-600">
        <i class="fas fa-list"></i>
    </a>
    <a href="{{ route('admin.users.index') }}" wire:navigate class="text-gray-700 dark:text-gray-300 hover:text-blue-600">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2"
            viewBox="0 0 24 24">
    ...
    <a href="{{ route('edit-profile') }}" wire:navigate class="text-gray-700 dark:text-gray-300 hover:text-blue-600">
        <!-- Profile Icon -->
